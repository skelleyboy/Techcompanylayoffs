  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-6 sm:py-10">
        ...
        {/* Header */}
        <header className="sticky top-0 z-40 flex items-center justify-between gap-3 mb-8 animate-in fade-in slide-in-from-top-4 duration-700 bg-background/80 backdrop-blur-sm py-2 pr-2 sm:pr-0">
          <img
            src={logoImg}
        ...
        <div className="relative mb-12 animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100 fill-mode-both" data-testid="section-hero">
          <div
            aria-hidden="true"
            className="absolute -right-6 sm:-right-8 top-0 w-[16rem] sm:w-[40rem] pointer-events-none select-none -z-10"
          >
            <img
              src={reaperImg}
              alt=""
